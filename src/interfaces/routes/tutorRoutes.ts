...
import { addProfile, createCourse, showCategory, showCourseDetails, showCourses, showProfile, tutorRegister, videoUpload } from '../controllers/tutorController';
...
tutorRouter.get('/course-list',showCourses);
